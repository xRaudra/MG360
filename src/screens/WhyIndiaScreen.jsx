...
const advantages = [
  {
    ...
    desc: 'The same surgery that costs $80,000 in the US costs $8,000 in India — with no compromise on quality or outcome.',
  },
  {
    icon: '🏆',
    color: '#1B4FBF',
    ...
    desc: 'India has more JCI-accredited hospitals than any other country in Asia. Apollo, Fortis, AIIMS — global names, local prices.',
  },
  {
    icon: '👨‍⚕️',
    color: '#7C3AED',
    ...
    desc: 'Most senior surgeons have trained in the US, UK, or Europe. English-speaking, globally certified, locally committed.',
  },
  {
    icon: '⚡',
    color: '#F59E0B',
    ...
    desc: 'Skip the 6–12 month NHS or public waitlists. Get a confirmed surgery date within days of your medical assessment.',
  },
  {
    icon: '🔬',
    color: '#0D9488',
    ...
    desc: 'Robotic surgery, proton therapy, AI diagnostics — India\'s top hospitals run the same equipment as leading US centres.',
  },
  {
    icon: '✈️',
    color: '#EC4899',
    ...
    desc: 'Direct or one-stop flights from Lagos, Nairobi, Accra, Dubai, and London to Delhi, Mumbai, and Chennai.',
  },
];
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-4 py-5 flex flex-col gap-6">
        ...
        <div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <div className="flex px-4 py-2.5 border-b border-slate-100">
              <p className="flex-1 text-xs font-bold text-slate-500 uppercase tracking-wider">Procedure</p>
        ...
        {/* Top specialties */}
        <div>
          <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-3">Top Specialties in India</p>
          <div className="grid grid-cols-3 gap-2">
            {specialties.map(s => (
