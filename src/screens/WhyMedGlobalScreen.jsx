...
const pillars = [
  {
    ...
    color: '#1B4FBF',
    bg: '#EFF6FF',
    title: 'Curated Hospital Network',
    desc: 'Only JCI & NABL accredited hospitals — hand-picked for safety, quality, and international patient care.',
  },
  {
    icon: Users,
    color: '#7C3AED',
    ...
    desc: 'Specialists who have treated thousands of international patients and communicate in your language.',
  },
  {
    icon: DollarSign,
    color: '#059669',
    ...
    desc: 'Detailed cost estimates before you book anything. No hidden fees, no surprises — ever.',
  },
  {
    icon: Clock,
    color: '#F59E0B',
    ...
    desc: 'Skip 6–12 month waitlists. Treatment begins within days of your arrival in India.',
  },
  {
    icon: Users,
    color: '#0D9488',
    ...
    desc: 'Your loved ones travel with you. We keep your Care Circle informed and supported throughout.',
  },
  {
    icon: Phone,
    color: '#EC4899',
    ...
    desc: 'A dedicated coordinator is with you at every stage — from your first question to your final follow-up.',
  },
];
